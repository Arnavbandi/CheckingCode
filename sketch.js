...
function setup(){
    ...
    log1 = new Log(1130,550,20,330,PI/2);
    ...
    log2 = new Log(1130,430,20,330,PI/2);

    box3= new Box(1000,450,70,70);

    box4 = new Box(1260,450,70,70);

    box5 = new Box(1130,420,70,70);

    pig2 = new Pig(1130,470);

    ground = new Ground(700,590,1400,30);

    log3 = new Log(1050,420,20,160,PI/7);

    log4 = new Log(1200,420,20,160,-PI/7);
